//
//  AsyncContinuationsAppDelegate.m
//  AsyncContinuations
//
...
@synthesize window, requestActivityIndicatorView;
...
- (void)dealloc {
    self.requestActivityIndicatorView = nil;
    self.window = nil;
    [super dealloc];
}
...
- (void)startRequest:(id)sender {
    ...
    [NSURLConnection sendRequest:request withResult:^(NSError *error,NSURLResponse *responce,NSData *responceData){
